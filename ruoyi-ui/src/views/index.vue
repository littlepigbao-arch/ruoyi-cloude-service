...
<!--    </el-row>-->
    <div class="card-box-custom">
      <div class="card-box-header">
        ...
        <div class="">
          <el-select placeholder="下属部门"></el-select>
          <el-button type="primary" style="margin: 5px;height: 34px;color: white">搜索</el-button>
        </div>
      </div>
    </div>
<!--    <el-divider />-->
...
<!--      </el-col>-->
<!--    </el-row>-->
    <div ref="chart" style="width: 800px; height: 400px;" class="container-chart"></div>
  </div>
</template>
